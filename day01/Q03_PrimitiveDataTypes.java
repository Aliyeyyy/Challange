...
public class Q03_PrimitiveDataTypes {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("İntMin = " + İntMin);
        int İntMax=Integer.MAX_VALUE;
        System.out.println("İntMax = " + İntMax);
        long LongMin= Long.MIN_VALUE;
        System.out.println("LongMin = " + LongMin);
        long LongMax=Long.MAX_VALUE;
        System.out.println("LongMax = " + LongMax);
        ...
        float telFiyat=14.999f;
        System.out.println("telFiyat = " + telFiyat);
        double boy=1.75;
        System.out.println("boy = " + boy);
        boolean emekliMi= false;
        System.out.println("emekliMi = " + emekliMi);
